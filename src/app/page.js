        ...
        <div className="container mx-auto px-4">
          ...
          <div className="mb-16">
            ...
            <div className="text-center">
              <p className="text-lg text-gray-600 mb-6">Koleksi Lengkap Karakter Populer dalam Format PDF - Klik untuk Download Sample</p>
              <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-6 max-w-4xl mx-auto">
                <a href="/Contoh Halaman E-Book Coloring Book/Avengers.pdf" download className="bg-gradient-to-br from-red-100 to-red-200 rounded-xl p-4 text-center hover:scale-105 transition-transform cursor-pointer">
                  <div className="text-3xl mb-2">🦸‍♂️</div>
                  <h4 className="font-bold text-gray-800">Avengers</h4>
                  <p className="text-xs text-gray-600 mt-1">📥 Download Sample</p>
                </a>
                <a href="/Contoh Halaman E-Book Coloring Book/Disney Mixed.pdf" download className="bg-gradient-to-br from-pink-100 to-pink-200 rounded-xl p-4 text-center hover:scale-105 transition-transform cursor-pointer">
                  <div className="text-3xl mb-2">👸</div>
                  <h4 className="font-bold text-gray-800">Disney</h4>
                  <p className="text-xs text-gray-600 mt-1">📥 Download Sample</p>
                </a>
                <a href="/Contoh Halaman E-Book Coloring Book/Doraemon.pdf" download className="bg-gradient-to-br from-blue-100 to-blue-200 rounded-xl p-4 text-center hover:scale-105 transition-transform cursor-pointer">
                  <div className="text-3xl mb-2">🤖</div>
                  <h4 className="font-bold text-gray-800">Doraemon</h4>
                  <p className="text-xs text-gray-600 mt-1">📥 Download Sample</p>
                </a>
                <a href="/Contoh Halaman E-Book Coloring Book/Dragon Ball Z.pdf" download className="bg-gradient-to-br from-orange-100 to-orange-200 rounded-xl p-4 text-center hover:scale-105 transition-transform cursor-pointer">
                  <div className="text-3xl mb-2">🐉</div>
                  <h4 className="font-bold text-gray-800">Dragon Ball</h4>
                  <p className="text-xs text-gray-600 mt-1">📥 Download Sample</p>
                </a>
                <a href="/Contoh Halaman E-Book Coloring Book/Minions.pdf" download className="bg-gradient-to-br from-yellow-100 to-yellow-200 rounded-xl p-4 text-center hover:scale-105 transition-transform cursor-pointer">
                  <div className="text-3xl mb-2">👾</div>
                  <h4 className="font-bold text-gray-800">Minions</h4>
                  <p className="text-xs text-gray-600 mt-1">📥 Download Sample</p>
                </a>
                <a href="/Contoh Halaman E-Book Coloring Book/My Little Pony Twilight Sparkle.pdf" download className="bg-gradient-to-br from-purple-100 to-purple-200 rounded-xl p-4 text-center hover:scale-105 transition-transform cursor-pointer">
                  <div className="text-3xl mb-2">🦄</div>
                  <h4 className="font-bold text-gray-800">My Little Pony</h4>
                  <p className="text-xs text-gray-600 mt-1">📥 Download Sample</p>
                </a>
                <a href="/Contoh Halaman E-Book Coloring Book/Naruto.pdf" download className="bg-gradient-to-br from-gray-100 to-gray-200 rounded-xl p-4 text-center hover:scale-105 transition-transform cursor-pointer">
                  <div className="text-3xl mb-2">🥷</div>
                  <h4 className="font-bold text-gray-800">Naruto</h4>
                  <p className="text-xs text-gray-600 mt-1">📥 Download Sample</p>
                </a>
                <a href="/Contoh Halaman E-Book Coloring Book/OnePiece.pdf" download className="bg-gradient-to-br from-green-100 to-green-200 rounded-xl p-4 text-center hover:scale-105 transition-transform cursor-pointer">
                  <div className="text-3xl mb-2">⚓</div>
                  <h4 className="font-bold text-gray-800">One Piece</h4>
                  <p className="text-xs text-gray-600 mt-1">📥 Download Sample</p>
                </a>
                <a href="/Contoh Halaman E-Book Coloring Book/Pokemon.pdf" download className="bg-gradient-to-br from-red-100 to-yellow-200 rounded-xl p-4 text-center hover:scale-105 transition-transform cursor-pointer">
                  <div className="text-3xl mb-2">⚡</div>
                  <h4 className="font-bold text-gray-800">Pokemon</h4>
                  <p className="text-xs text-gray-600 mt-1">📥 Download Sample</p>
                </a>
                <a href="/Contoh Halaman E-Book Coloring Book/Sanrio.pdf" download className="bg-gradient-to-br from-pink-100 to-purple-200 rounded-xl p-4 text-center hover:scale-105 transition-transform cursor-pointer">
                  <div className="text-3xl mb-2">🎀</div>
                  <h4 className="font-bold text-gray-800">Sanrio</h4>
                  <p className="text-xs text-gray-600 mt-1">📥 Download Sample</p>
                </a>
                <a href="/Contoh Halaman E-Book Coloring Book/Spongebob.pdf" download className="bg-gradient-to-br from-yellow-100 to-blue-200 rounded-xl p-4 text-center hover:scale-105 transition-transform cursor-pointer">
                  <div className="text-3xl mb-2">🧽</div>
                  <h4 className="font-bold text-gray-800">SpongeBob</h4>
                  <p className="text-xs text-gray-600 mt-1">📥 Download Sample</p>
                </a>
                <a href="/Contoh Halaman E-Book Coloring Book/Transformers.pdf" download className="bg-gradient-to-br from-blue-100 to-red-200 rounded-xl p-4 text-center hover:scale-105 transition-transform cursor-pointer">
                  <div className="text-3xl mb-2">🚗</div>
